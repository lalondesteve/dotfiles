...
- Keep for yourself: design decisions, the core user-facing edits, and final verification.
...
Return a concise summary of what changed, the design rationale, verification performed, and any follow-up needed.

---
description: Use for risk-based code review after behavior-changing, multi-file, or otherwise regression-prone implementation; checks correctness, regressions, tests, maintainability, and repository conventions.
mode: subagent
